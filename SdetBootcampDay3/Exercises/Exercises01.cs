...
namespace SdetBootcampDay3.Exercises
{
    ...
    public class Exercises01
    {
        ...
        public async Task GetDataForUser5_CheckCompanyName_ShouldBeKeeblerLLC()
        {
            ...
            Assert.That(responseData.SelectToken("company")!.ToString(), Does.Contain("Keebler LLC"));                          //Not ideal
            Assert.That(responseData.SelectToken("company")!.SelectToken("name")!.ToString(), Is.EqualTo("Keebler LLC"));       //Better
            Assert.That(responseData.SelectToken("company.name")!.ToString(), Is.EqualTo("Keebler LLC"));                       //More elegant
