...
namespace SdetBootcampDay3.Exercises
{
    ...
    public class Exercises02
    {
        ...
        [Test, TestCaseSource ("CheckNameForUser")]
        public async Task CheckNameForUser_function(string id, string name)
        {
