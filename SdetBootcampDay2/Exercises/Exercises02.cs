...
namespace SdetBootcampDay2.Exercises
{
    ...
    public class Exercises02
    {
        ...
        public void MockPaymentProcessor_ReturnFalseForAllStripePayments()
        {
            ...
            var handler = new OrderHandler(stock, mockProcessor.Object);

            handler.Order(OrderItem.FIFA_24, 10);

            Assert.That(handler.PayFor(OrderItem.FIFA_24, 10), Is.False);
             ...
             */
             ...
             mockProcessor.Verify(handler => handler.PayFor(OrderItem.FIFA_24, 10), Times.Once());
